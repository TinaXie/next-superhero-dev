...
var lY=_mz(z,'swiper',['autoplay',1,'class',1,'indicatorActiveColor',2,'indicatorDots',3,'interval',4],[],e,s,gg)
var aZ=_v()
_(lY,aZ)
var t1=function(b3,e2,o4,gg){
var o6=_n('swiper-item')
var f7=_mz(z,'navigator',['openType',9,'url',1],[],b3,e2,gg)
var c8=_mz(z,'image',['class',11,'src',1],[],b3,e2,gg)
_(f7,c8)
_(o6,f7)
_(o4,o6)
return o4
...
aZ.wxXCkey=2
_2z(z,8,t1,e,s,gg,aZ,'carousel','__i0__','')
_(oX,lY)
var h9=_n('view')
_rz(z,h9,'class',13,e,s,gg)
var o0=_n('view')
_rz(z,o0,'class',14,e,s,gg)
var cAB=_mz(z,'image',['class',15,'src',1],[],e,s,gg)
_(o0,cAB)
var oBB=_n('view')
...
var fKB=_n('view')
_rz(z,fKB,'class',24,oHB,bGB,gg)
var cLB=_n('view')
_rz(z,cLB,'class',25,oHB,bGB,gg)
var hMB=_mz(z,'navigator',['openType',26,'url',1],[],oHB,bGB,gg)
var oNB=_mz(z,'image',['class',28,'src',1],[],oHB,bGB,gg)
_(hMB,oNB)
_(cLB,hMB)
var cOB=_n('view')
_rz(z,cOB,'class',30,oHB,bGB,gg)
var oPB=_oz(z,31,oHB,bGB,gg)
_(cOB,oPB)
_(cLB,cOB)
var lQB=_mz(z,'trailer-starts',['bind:__l',32,'innerScore',1,'showNum',2,'vueId',3],[],oHB,bGB,gg)
_(cLB,lQB)
_(fKB,cLB)
_(xIB,fKB)
return xIB
...
tEB.wxXCkey=4
_2z(z,23,eFB,e,s,gg,tEB,'superHero','__i1__','')
_(oX,aDB)
var aRB=_n('view')
_rz(z,aRB,'class',36,e,s,gg)
var tSB=_n('view')
_rz(z,tSB,'class',37,e,s,gg)
var eTB=_mz(z,'image',['class',38,'src',1],[],e,s,gg)
_(tSB,eTB)
var bUB=_n('view')
...
var o4B=_mz(z,'video',['controls',-1,'class',46,'poster',1,'src',2],[],h1B,cZB,gg)
_(o2B,o4B)
return o2B
}
oXB.wxXCkey=2
_2z(z,45,fYB,e,s,gg,oXB,'trailer','__i2__','')
_(oX,xWB)
var l5B=_n('view')
_rz(z,l5B,'class',49,e,s,gg)
var a6B=_n('view')
_rz(z,a6B,'class',50,e,s,gg)
var t7B=_mz(z,'image',['class',51,'src',1],[],e,s,gg)
_(a6B,t7B)
var e8B=_n('view')
_rz(z,e8B,'class',53,e,s,gg)
var b9B=_oz(z,54,e,s,gg)
_(e8B,b9B)
_(a6B,e8B)
_(l5B,a6B)
_(oX,l5B)
...
var cGC=_n('view')
_rz(z,cGC,'class',59,cDC,fCC,gg)
var oHC=_mz(z,'navigator',['openType',60,'url',1],[],cDC,fCC,gg)
var lIC=_mz(z,'image',['class',62,'src',1],[],cDC,fCC,gg)
_(oHC,lIC)
_(cGC,oHC)
var aJC=_n('view')
_rz(z,aJC,'class',64,cDC,fCC,gg)
var tKC=_n('view')
_rz(z,tKC,'class',65,cDC,fCC,gg)
var eLC=_oz(z,66,cDC,fCC,gg)
_(tKC,eLC)
_(aJC,tKC)
var bMC=_mz(z,'trailer-starts',['bind:__l',67,'innerScore',1,'showNum',2,'vueId',3],[],cDC,fCC,gg)
_(aJC,bMC)
var oNC=_n('view')
_rz(z,oNC,'class',71,cDC,fCC,gg)
var xOC=_oz(z,72,cDC,fCC,gg)
_(oNC,xOC)
_(aJC,oNC)
var oPC=_n('view')
_rz(z,oPC,'class',73,cDC,fCC,gg)
var fQC=_oz(z,74,cDC,fCC,gg)
_(oPC,fQC)
_(aJC,oPC)
_(cGC,aJC)
var cRC=_mz(z,'view',['bindtap',75,'class',1,'data-event-opts',2,'data-gIndex',3],[],cDC,fCC,gg)
var hSC=_mz(z,'image',['class',79,'src',1],[],cDC,fCC,gg)
_(cRC,hSC)
var oTC=_n('view')
_rz(z,oTC,'class',81,cDC,fCC,gg)
var cUC=_oz(z,82,cDC,fCC,gg)
_(oTC,cUC)
_(cRC,oTC)
var oVC=_mz(z,'view',['animation',83,'class',1],[],cDC,fCC,gg)
var lWC=_oz(z,85,cDC,fCC,gg)
_(oVC,lWC)
_(cRC,oVC)
_(cGC,cRC)
_(hEC,cGC)
...
xAC.wxXCkey=4
_2z(z,58,oBC,e,s,gg,xAC,'guess','gIndex','')
_(oX,o0B)
_(r,oX)
return r
}
...
var o4C=_mz(z,'video',['controls',-1,'class',2,'poster',1,'src',2],[],e,s,gg)
_(x3C,o4C)
_(o2C,x3C)
var f5C=_n('view')
_rz(z,f5C,'class',5,e,s,gg)
var c6C=_n('navigator')
_rz(z,c6C,'url',6,e,s,gg)
var h7C=_mz(z,'image',['class',7,'mode',1,'src',2],[],e,s,gg)
_(c6C,h7C)
_(f5C,c6C)
var o8C=_n('view')
...
var tQD=_mz(z,'trailer-starts',['bind:__l',29,'innerScore',1,'showNum',2,'vueId',3],[],e,s,gg)
_(aPD,tQD)
}
var eRD=_n('view')
...
var cXD=_oz(z,39,e,s,gg)
_(fWD,cXD)
_(oVD,fWD)
var hYD=_n('view')
_rz(z,hYD,'class',40,e,s,gg)
var oZD=_oz(z,41,e,s,gg)
_(hYD,oZD)
_(oVD,hYD)
_(o2C,oVD)
var c1D=_n('view')
...
var l3D=_oz(z,44,e,s,gg)
_(o2D,l3D)
_(c1D,o2D)
var a4D=_mz(z,'scroll-view',['scrollX',-1,'class',45],[],e,s,gg)
var t5D=_v()
_(a4D,t5D)
var e6D=function(o8D,b7D,x9D,gg){
var fAE=_n('view')
_rz(z,fAE,'class',49,o8D,b7D,gg)
var cBE=_mz(z,'image',['bindtap',50,'class',1,'data-event-opts',2,'data-staffIndex',3,'mode',4,'src',5],[],o8D,b7D,gg)
_(fAE,cBE)
var hCE=_n('view')
_rz(z,hCE,'class',56,o8D,b7D,gg)
var oDE=_oz(z,57,o8D,b7D,gg)
_(hCE,oDE)
_(fAE,hCE)
var cEE=_n('view')
_rz(z,cEE,'class',58,o8D,b7D,gg)
var oFE=_oz(z,59,o8D,b7D,gg)
_(cEE,oFE)
_(fAE,cEE)
_(x9D,fAE)
return x9D
...
t5D.wxXCkey=2
_2z(z,48,e6D,e,s,gg,t5D,'director','staffIndex','')
var lGE=_v()
_(a4D,lGE)
var aHE=function(eJE,tIE,bKE,gg){
var xME=_n('view')
_rz(z,xME,'class',63,eJE,tIE,gg)
var oNE=_mz(z,'image',['bindtap',64,'class',1,'data-event-opts',2,'data-staffIndex',3,'mode',4,'src',5],[],eJE,tIE,gg)
_(xME,oNE)
var fOE=_n('view')
_rz(z,fOE,'class',70,eJE,tIE,gg)
var cPE=_oz(z,71,eJE,tIE,gg)
_(fOE,cPE)
_(xME,fOE)
var hQE=_n('view')
...
lGE.wxXCkey=2
_2z(z,62,aHE,e,s,gg,lGE,'actor','actorIndex','')
_(c1D,a4D)
_(o2C,c1D)
var cSE=_n('view')
...
_(oTE,lUE)
_(cSE,oTE)
var aVE=_mz(z,'scroll-view',['scrollX',-1,'class',77],[],e,s,gg)
var tWE=_v()
_(aVE,tWE)
var eXE=function(oZE,bYE,x1E,gg){
var f3E=_mz(z,'image',['bindtap',81,'class',1,'data-event-opts',2,'data-imageIndex',3,'mode',4,'src',5],[],oZE,bYE,gg)
_(x1E,f3E)
return x1E
}
tWE.wxXCkey=2
_2z(z,80,eXE,e,s,gg,tWE,'img','imgIndex','')
_(cSE,aVE)
_(o2C,cSE)
_(r,o2C)
return r
...
_(c7E,o8E)
_(o6E,c7E)
var l9E=_mz(z,'input',['bindconfirm',5,'class',1,'confirmType',2,'data-event-opts',3,'maxlength',4,'placeholder',5,'type',6],[],e,s,gg)
_(o6E,l9E)
_(h5E,o6E)
var a0E=_n('view')
...
var fGF=_n('view')
_rz(z,fGF,'class',16,oDF,bCF,gg)
var cHF=_mz(z,'image',['bindtap',17,'class',1,'data-event-opts',2,'data-trailerID',3,'src',4],[],oDF,bCF,gg)
_(fGF,cHF)
_(xEF,fGF)
return xEF
}
tAF.wxXCkey=2
_2z(z,15,eBF,e,s,gg,tAF,'trailer','__i0__','')
_(h5E,a0E)
_(r,h5E)
return r
}
